        ...
        <div class="container">
            <div class="inner-sec py-lg-5  py-3">
                <div class="title-section text-center pb-lg-5">
                    ...
                    <h3 class="w3ls-title text-center text-capitalize">Excercise</h3>
                </div>
                ...
                <div class="col-lg-10 col-md-6">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0">
                            <iframe width="575" height="315" src="https://www.youtube.com/embed/VdxDnuXj4yc" frameborder="0" allow="accelerometer; 
