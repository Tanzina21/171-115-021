<!-- footer -->
    ...
    <script src="<?=base_url()?>asset5/js/jquery.flexisel.js"></script>
    <script>
    ...
    <script src="<?=base_url()?>asset5/js/easing.js"></script>
    <script>
    ...
    <script src="<?=base_url()?>asset5/js/SmoothScroll.min.js"></script>
...
<!-- //bootstrap-modal-pop-up --> 
	<script src="<?=base_url()?>asset5/js/jquery.vide.min.js"></script>
	<script src="<?=base_url()?>asset5/js/jquery.magnific-popup.js" type="text/javascript"></script>
