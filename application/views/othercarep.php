    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
			    <a href="<?=base_url()?>welcome/pregnancy">Pregnancy</a>
            </li>
        ...
        <div class="container">
            <div class="inner-sec py-lg-5  py-3">
                <div class="title-section text-center pb-lg-5">
                    ...
                    <h3 class="w3ls-title text-center text-capitalize">Pregnancy Complications</h3>
                </div>
                    ...
                    <div class="col-lg-8 left-blog-info text-left">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title ">
                                    <a href="">Pregnancy Complications</a>
                                </h5>
                ...
                <div class="col-lg-10 col-md-6">
                    <div class="card border-0 med-blog">
                        <div class="card-header p-0">
                            <iframe width="575" height="315" src="https://www.youtube.com/embed/w2M2Ua4HASg" frameborder="0" 
                        ...
                        <div class="card-body border-0 px-0">
                            ...
                            <div class="pt-2">
                                <h5 class="blog-title card-title font-weight-bold">
                                    <a href="">Pregnancy Complications Video</a>
                                </h5>
                            </div>
