            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
						...
						<li>
                            <a href="<?=base_url()?>signup">Add User</a>
                        </li>
						<li>
                            <a href="<?=base_url()?>admin/add_department">Add User</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>admin/view_user">View User</a>
                        </li>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            ...
                            <a href="<?=base_url()?>admin/add_department">Add Department</a>
                            <a href="<?=base_url()?>admin/add_expert">Add Expert</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>admin/view_user">View User</a>
                            <a href="<?=base_url()?>admin/view_department">View Department</a>
                            <a href="<?=base_url()?>admin/view_expert">View Expert</a>
							<a href="<?=base_url()?>admin/view_booking">View Bookings</a>
							  <a href="<?=base_url()?>admin/view_gallery">View gallery</a>
                        </li>
